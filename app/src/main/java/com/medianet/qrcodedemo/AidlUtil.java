...
public class AidlUtil {
   ...
   /* public void printTable(LinkedList<TableItem> list) {
    ...
    public void prepareDataToPrint(String heading, byte[] data, String total, byte[] footer) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        try {
            ...
            woyouService.setAlignment(1, null);
            woyouService.sendRAWData(ESCUtil.boldOn(), null);
            woyouService.printTextWithFont(heading, null, 25f, null);
            //woyouService.lineWrap(3, null);
            // Content
            woyouService.sendRAWData(ESCUtil.boldOff(), null);
            ...
            woyouService.sendRAWData(ESCUtil.boldOn(), null);
            woyouService.printTextWithFont(total, null, 28f, null);
            // Footer
            woyouService.sendRAWData(ESCUtil.boldOff(), null);
            woyouService.setAlignment(1, null);
            woyouService.sendRAWData(footer, null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
